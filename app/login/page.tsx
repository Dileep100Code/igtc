  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center">
      <form className="form" onSubmit={handleSubmit}>
        <h2 className="text-2xl font-bold text-center mb-6 text-black">IGTC Login</h2>
        ...
        <div className="flex-row">
          ...
          <a href="/forgot-password" className="span">Forgot password?</a>
        </div>
        ...
        <div className="flex-row">
          ...
          <button className="btn discord" type="button">
